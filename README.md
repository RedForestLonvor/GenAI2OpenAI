...
- Python 3.11 及以上版本
- 依赖包见 `pyproject.toml`，包括 Flask、Requests、Icecream 等
...
（可根据 `pyproject.toml` 中的依赖列表自行生成或使用 Poetry 管理）
...
- 使用 `genai_client.py` 提供的示例代码，可以快速对接 GenAI API，进行流式聊天交互。
...
- 联系邮箱：please-replace-with-your-email@example.com
